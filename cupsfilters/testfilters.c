...
typedef int (*cf_filter_func_t)(int input_fd, int output_fd, int input_seekable, cf_filter_data_t *data, void *parameters);   // Function pointer type for filter functions
...
//
// 'parse_filter_chain()' - Parse a filter chain string into an array of filter functions and their parameters.
//

cups_array_t*                                     // O - Array of filter functions and their parameters
parse_filter_chain(const char *filter_chain_str,   // I - Filter chain string (comma-separated)
...
int                       // O - Exit status
test_wrapper(
   	int num_clargs,     // I - Number of command-line arguments
    	char *clargs[],     // I - Command-line arguments
	void *parameters,             // I - Filter function parameters
	int *JobCanceled,             // I - Variable set to 1 when job is canceled
    	ipp_t* emulated_ipp,      // I - Emulated IPP attributes
	...
	cups_array_t *filter_chain)     // I - Array of filter functions and their parameters
{
